 ...
 *  como parámetro  y su responsabilidad es invertir los caracteres de la misma. Ejemplo
 *   si le pasamos UTN-FRA la deja como ARF-NTU*/


/*3. Crear una función que se llame ordenarCaracteres que reciba una cadena de
 *  caracteres como parámetro  y su responsabilidad es ordenar los caracteres de
